...
//      'src/css/*.less',
            ...
            {pattern: 'test/widget/**', included: false},
            'test/main.js'
        ],
...
//      'src/**/*.less': ['less']
        ...
        plugins: [
            'karma-jasmine', 'karma-chrome-launcher', 'karma-firefox-launcher', /*'karma-safari-launcher', */'karma-phantomjs-launcher', 'karma-requirejs', 'karma-coverage'
        ]
    });
};
